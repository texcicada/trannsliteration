...
{
%\str_set:Nn \l_myugx_str { #1 }
%\tl_set:Nn \l_myugx_tl { #1 }
%\tl_set:Nn \l_myugx_tl { \sugtransrev{#1} }
%\tl_to_str:V { \l_myugx_tl }
\setlength{\tabcolsep}{-0.5pt} 
\begin{tabular}[b]{c}
%\scriptsize\sugtransrev{\str_use:N \l_myugx_str}  \\
%\scriptsize\sugtransrev{\tl_use:N \l_myugx_tl}  \\
%\exp_args:cc { \l_myugx_f } { #1 }
%\scriptsize \exp_args:Nx \sugtransrev {#1}  \\
%\scriptsize\sugtransrev{\exp:w #1 \exp_end:}  \\
%\tl_use:N \l_myugx_tl \\
